...
function ToastViewport({ toasts, dismiss }) {
    return (
        <div className="pointer-events-none fixed top-5 right-5 z-50 flex flex-col gap-2.5 w-90 max-w-[calc(100vw-32px)]">
                ...
                {toasts.map((t) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className="pointer-events-auto bg-(--surface) border border-(--border) shadow-hover rounded-2xl p-3.5 flex items-start gap-3"
                        >
                            <div
                                className={cn(
                            ...
                            <button
                                ...
                                className="h-7 w-7 rounded-full hover:bg-(--surface-2) flex items-center justify-center text-(--ink-muted) shrink-0"
                                aria-label="Dismiss"
                            >
                                <X size={13} />
                            </button>
